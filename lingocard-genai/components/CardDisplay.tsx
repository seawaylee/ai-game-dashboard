...
export const CardDisplay: React.FC<CardDisplayProps> = ({ appState }) => {
  ...
  return (
    <div className="flex-1 h-full bg-stone-100 overflow-hidden relative font-['Inter']">
      {/* Wrapper: Reduced padding to maximize space */}
      <div className="h-full w-full flex items-center justify-center p-2 lg:p-4">

        {/* Card Container: Removed max-w-6xl to fill screen more, adjusted height to fill available space */}
        <div className="w-full h-full bg-white rounded-[1.5rem] shadow-2xl overflow-hidden border-[4px] border-stone-900 flex flex-col relative">

          {/* Header */}
          <div className="bg-[#FFD966] p-3 lg:p-4 border-b-[4px] border-stone-900 flex justify-between items-center shrink-0">
            <h1 className="text-xl lg:text-3xl font-black text-stone-900 tracking-tight uppercase font-['Fredoka'] truncate mr-4">
              {content.topic}
            </h1>
          ...
          {/* Footer Actions */}
          <div className="p-3 bg-white border-t-[4px] border-stone-900 flex justify-between items-center shrink-0 hidden lg:flex">
